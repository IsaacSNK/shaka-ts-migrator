...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String shakaFolderPath = "C:\\dev-workspace\\shaka-player-fork";
        ...
        TypeScriptGenerator.GentsResult gentsResult = gents.generateTypeScript(filesToConvert, sourceFiles, getExterns(shakaFolderPath + "\\externs"));
    ...
    private static List<SourceFile> getExterns(String basepath) {
        Set<Path> files = getAllFilesRecursively(basepath);
