 ...
 */
public final class NamespaceConversionPass implements CompilerPass {
  ...
  private final Map<String, CollectModuleMetadata.FileModule> fileToModule;
  private final Map<String, CollectModuleMetadata.FileModule> namespaceToModule;
  ...
  NamespaceConversionPass(
      AbstractCompiler compiler,
      PathUtil pathUtil,
      NameUtil nameUtil,
      Map<String, CollectModuleMetadata.FileModule> fileToModule,
      Map<String, CollectModuleMetadata.FileModule> namespaceToModule,
    ...
    public void visit(NodeTraversal t, Node n, Node parent) {
      ...
      if (n.isScript()) {
        if (fileToModule.containsKey(fileName)) {
          ...
          CollectModuleMetadata.FileModule module = fileToModule.get(fileName);
  ...
  private class ModuleImport {
    ...
    private CollectModuleMetadata.FileModule module;
